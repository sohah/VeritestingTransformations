...
public class OptStaticBranchChoiceGenerator extends StaticPCChoiceGenerator {
    ...
    public OptStaticBranchChoiceGenerator(DynamicRegion region, Instruction instruction) {
