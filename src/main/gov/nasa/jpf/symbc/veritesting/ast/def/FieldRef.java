...
public class FieldRef {
    ...
    public static FieldRef makeGetFieldRef(ThreadInfo ti, GetInstruction getIns) throws StaticRegionException {
        if (!(getIns.ref instanceof IntConstant) && !getIns.getOriginal().isStatic())
            throwException(new IllegalArgumentException("cannot make FieldRef for symbolic object reference"));
        ...
        if (ref == 0) throwException(new StaticRegionException("Cannot get any information from null objects"));
