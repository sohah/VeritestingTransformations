...
public class AmbiguousOptionException extends UnrecognizedOptionException
{
     ...
     */
    public AmbiguousOptionException(char option, Collection<String> matchingOptions)
    {
     ...
     * @return
     */
    private static String createMessage(char option, Collection<String> matchingOptions)
    {
