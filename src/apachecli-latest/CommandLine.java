...
public class CommandLine implements Serializable
{
    ...
    private final List args = new LinkedList<String>();
    ...
    {
        return options.contains(resolveOption(opt.toCharArray()));
    }
    ...
    public Object getOptionObject(char opt)
    {
        return getOptionObject(new char[]{opt});
    }
    ...
    public String getOptionValue(char opt)
    {
        return getOptionValue(new char[]{opt});
    }
    ...
    public String[] getOptionValues(char[] opt)
    {
        ...
        {
            if (opt[0] == (option.getOpt()) || opt[0] == (option.getLongOpt()))
            {
    ...
    private Option resolveOption(char[] opt)
    {
        ...
        for (Option option : options)
        {
            if (opt[0] == option.getOpt())
            {
                return option;
            }

            if (opt[0] == option.getLongOpt())
            {
                return option;
            }
    ...
    public String[] getOptionValues(char opt)
    {
        return getOptionValues(new char[]{opt});
    }
    ...
    {
        String answer = getOptionValue(opt.toCharArray());
    ...
    */
     ...
     */
    protected void addArg(char[] arg)
    {
        args.add(arg);
    }
    ...
    public static final class Builder
    {
         ...
         * @return this Builder instance for method chaining.
         */
        public Builder addArg(char[] arg)
        {
