...
public class Option implements Cloneable, Serializable
{
     ...
     * Option characters in <code>opt</code>.
     */
    public Option(char opt, boolean hasArg, String description) throws IllegalArgumentException
    {
        this(opt, '\0', 1, description);
    }
     ...
     * Option characters in <code>opt</code>.
     */
    public Option(char opt, char longOpt, int hasArg, String description)
...
//        }
     ...
     */
    void addValueForProcessing(char[] value)
    {
     ...
     * @since 1.0.1
     */
    private void processValue(char[] value)
    {
        ...
        if (hasValueSeparator())
        {
            ...
            int index = Arrays.asList(value).indexOf(sep);
...
//                add(value.substring(0, index));
                add(Arrays.copyOfRange(value, 0, index));

                // parse
//                value = value.substring(index + 1);
                value = Arrays.copyOfRange(value, index+1, value.length);

                // get new index
//                index = value.indexOf(sep);
                index= Arrays.asList(value).indexOf(sep);
            }
        }
    ...
    public boolean equals(Object o)
    {
        ...
        if (opt != '\0' ? opt != option.opt : option.opt != '\0')
        {
            return false;
        }
        if (longOpt != '\0' ? longOpt != option.longOpt : option.longOpt != '\0')
        {
            return false;
        }
    ...
    public int hashCode()
    {
        int result;
        result = opt != '\0' ? opt : 0;
        result = 31 * result + (longOpt != '\0' ? longOpt : 0);
        return result;
    }
     ...
     * @since 1.3
     */
    public static Builder builder(final char opt)
    {
    ...
    public static final class Builder 
    {
         ...
         * @throws IllegalArgumentException if there are any non valid Option characters in {@code opt}
         */
        private Builder(final char opt) throws IllegalArgumentException
        {
            OptionValidator.validateOption(opt);
            this.opt = opt;
        }
         ...
         * @return this builder, to allow method chaining
         */        
        public Builder longOpt(final char longOpt)
        {
            this.longOpt = longOpt;
            return this;
        }
