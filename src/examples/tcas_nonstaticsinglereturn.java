...
public class tcas_nonstaticsinglereturn {
    ...
    public boolean equals(Object obj) {
        if (tcas_nonstaticsinglereturn.class.isInstance(obj)) {
            tcas_nonstaticsinglereturn o = (tcas_nonstaticsinglereturn) obj;
            return true;
        }
        return false;
    }
...
*/
    ...
    public static void main(String[] argv) {
        tcas_nonstaticsinglereturn t = new tcas_nonstaticsinglereturn();
