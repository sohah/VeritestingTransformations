...
class AnMain {
                            ...
                            if (haltProgram2) {
...

                                {
                                    ...
                                    while (haltProgram2 && runWhileLoopOnce2) {
                                        ...
                                        actionIsActivate = makeStep(padUnitManager, rocketAction, intNumOfPad, padNumber, rocketNumber, ActionIsTimeout);
    ...
    private static boolean makeStep(PadUnitManager padUnitManager, int rocketAction, int intNumOfPad, int padNumber, int rocketNumber, boolean actionIsTimeout) throws InvalidInputException {
