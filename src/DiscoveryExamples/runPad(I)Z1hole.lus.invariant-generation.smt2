...
(assert (=> act1 (not (and false $Check_spec~1.H_discovery~0.out$0 (not $Check_spec~1.H_discovery~0.out$0) $Check_spec~1.T_node~0.launch_bt$0 (not $Check_spec~1.T_node~0.launch_bt$0) $~flatten2$0 (not $~flatten2$0) (>= $sig0$0 1) (<= $sig0$0 1) $~flatten3$0 (not $~flatten3$0) (>= $~flatten0$0 1) (<= $~flatten0$0 1) (>= $~flatten1$0 0) (<= $~flatten1$0 0) $Check_spec~0.T_node~0.launch_bt$0 (not $Check_spec~0.T_node~0.launch_bt$0) $out0$0 (not $out0$0) $Check_spec~0.H_discovery~0.out$0 (not $Check_spec~0.H_discovery~0.out$0) $Check_spec~0.T_node~0.start_bt$0 (not $Check_spec~0.T_node~0.start_bt$0) $ok$0 (not $ok$0) $Check_spec~0.T_node~0.reset_flag$0 (not $Check_spec~0.T_node~0.reset_flag$0) $Check_spec~1.T_node~0.p1$0 (not $Check_spec~1.T_node~0.p1$0) $Check_spec~1.T_node~0.start_bt$0 (not $Check_spec~1.T_node~0.start_bt$0) $Check_spec~0.T_node~0.p1$0 (not $Check_spec~0.T_node~0.p1$0) (>= $Check_spec~1.step$0 0) (<= $Check_spec~1.step$0 0) $hole_5$0 (not $hole_5$0) (>= $Check_spec~0.step$0 0) (<= $Check_spec~0.step$0 0) $hole_6$0 (not $hole_6$0) $hole_3$0 (not $hole_3$0) $hole_4$0 (not $hole_4$0) $hole_1$0 (not $hole_1$0) $hole_2$0 (not $hole_2$0) $Check_spec~1.T_node~0.reset_flag$0 (not $Check_spec~1.T_node~0.reset_flag$0) $hole_0$0 (not $hole_0$0) $hole_7$0 (not $hole_7$0) $hole_8$0 (not $hole_8$0)))))
(check-sat act1)
(echo "@DONE")
; Z3: sat
; Z3: @DONE
