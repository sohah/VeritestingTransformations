...
(assert $ok$1)
; K = 3
(declare-fun $signal$2 () Int)
(declare-fun $ignition$2 () Bool)
(declare-fun $ok$2 () Bool)
(declare-fun $T_node_orig~0.start_bt$2 () Bool)
(declare-fun $T_node_orig~0.launch_bt$2 () Bool)
(declare-fun $T_node_orig~0.reset_flag$2 () Bool)
(declare-fun $T_node_repaired~0.start_bt$2 () Bool)
(declare-fun $T_node_repaired~0.launch_bt$2 () Bool)
(declare-fun $T_node_repaired~0.reset_flag$2 () Bool)
(assert (T false $signal$1 $ignition$1 $ok$1 $T_node_orig~0.start_bt$1 $T_node_orig~0.launch_bt$1 $T_node_orig~0.reset_flag$1 $T_node_repaired~0.start_bt$1 $T_node_repaired~0.launch_bt$1 $T_node_repaired~0.reset_flag$1 $signal$2 $ignition$2 $ok$2 $T_node_orig~0.start_bt$2 $T_node_orig~0.launch_bt$2 $T_node_orig~0.reset_flag$2 $T_node_repaired~0.start_bt$2 $T_node_repaired~0.launch_bt$2 $T_node_repaired~0.reset_flag$2))
...
; Z3:     false)
; Z3:   (define-fun $T_node_orig~0.reset_flag$2 () Bool
; Z3:     true)
; Z3:   (define-fun $signal$1 () Int
; Z3:     0)
; Z3:   (define-fun $T_node_orig~0.launch_bt$2 () Bool
; Z3:     true)
...
; Z3:     false)
; Z3:   (define-fun $T_node_repaired~0.reset_flag$2 () Bool
; Z3:     true)
; Z3:   (define-fun $T_node_repaired~0.start_bt$2 () Bool
; Z3:     true)
; Z3:   (define-fun $T_node_repaired~0.start_bt$0 () Bool
; Z3:     false)
; Z3:   (define-fun $T_node_repaired~0.launch_bt$2 () Bool
; Z3:     false)
; Z3:   (define-fun $signal$2 () Int
; Z3:     1)
; Z3:   (define-fun $T_node_repaired~0.start_bt$1 () Bool
; Z3:     true)
; Z3:   (define-fun $T_node_orig~0.start_bt$2 () Bool
; Z3:     true)
