...
(and
  (= $sig0$1 (ite %init 1 $~flatten1$0))
  (= $out0$1 (ite %init false $~flatten3$0))
  (= $ok$1 (not (and $Check_spec~0.ok$1 $Check_spec~1.ok$1)))
  (= $Check_spec~0.step$1 (ite %init 0 (+ 1 $Check_spec~0.step$0)))
  (= $Check_spec~0.stepOK$1 (ite (<= $Check_spec~0.step$1 3) $Check_spec~0.T_node~0.ok$1 true))
  (= $Check_spec~0.ok$1 (and (> $Check_spec~0.step$1 3) $Check_spec~0.H_discovery~0.out$1))
  (= $Check_spec~1.step$1 (ite %init 0 (+ 1 $Check_spec~1.step$0)))
  (= $Check_spec~1.stepOK$1 (ite (<= $Check_spec~1.step$1 0) $Check_spec~1.T_node~0.ok$1 true))
  (= $Check_spec~1.ok$1 (and (> $Check_spec~1.step$1 0) $Check_spec~1.H_discovery~0.out$1))
  (= $Check_spec~0.T_node~0.start_bt$1 (ite %init $hole_2$1 (ite $Check_spec~0.T_node~0.reset_flag$0 $hole_0$1 (ite (and (and (not $Check_spec~0.T_node~0.start_bt$0) (not $Check_spec~0.T_node~0.launch_bt$0)) (= $sig0$1 0)) $hole_1$1 $Check_spec~0.T_node~0.start_bt$0))))
  (= $Check_spec~0.T_node~0.launch_bt$1 (ite %init $hole_5$1 (ite $Check_spec~0.T_node~0.reset_flag$0 $hole_3$1 (ite (and (and $Check_spec~0.T_node~0.start_bt$0 (not $Check_spec~0.T_node~0.launch_bt$0)) (= $sig0$1 1)) $hole_4$1 $Check_spec~0.T_node~0.launch_bt$0))))
  (= $Check_spec~0.T_node~0.reset_flag$1 (ite %init $hole_6$1 $out0$0))
  (= $Check_spec~0.T_node~0.p1$1 (= $out0$1 (ite %init $hole_7$1 (and (and $Check_spec~0.T_node~0.launch_bt$0 (not $Check_spec~0.T_node~0.reset_flag$1)) (not $Check_spec~0.T_node~0.reset_flag$0)))))
  (= $Check_spec~0.T_node~0.ok$1 (ite %init $hole_8$1 $Check_spec~0.T_node~0.p1$1))
  (= $Check_spec~0.H_discovery~0.out$1 (ite %init $Check_spec~0.stepOK$1 (and $Check_spec~0.stepOK$1 $Check_spec~0.H_discovery~0.out$0)))
  (= $Check_spec~1.T_node~0.start_bt$1 (ite %init $hole_2$1 (ite $Check_spec~1.T_node~0.reset_flag$0 $hole_0$1 (ite (and (and (not $Check_spec~1.T_node~0.start_bt$0) (not $Check_spec~1.T_node~0.launch_bt$0)) (= 1 0)) $hole_1$1 $Check_spec~1.T_node~0.start_bt$0))))
  (= $Check_spec~1.T_node~0.launch_bt$1 (ite %init $hole_5$1 (ite $Check_spec~1.T_node~0.reset_flag$0 $hole_3$1 (ite (and (and $Check_spec~1.T_node~0.start_bt$0 (not $Check_spec~1.T_node~0.launch_bt$0)) (= 1 1)) $hole_4$1 $Check_spec~1.T_node~0.launch_bt$0))))
  (= $Check_spec~1.T_node~0.reset_flag$1 (ite %init $hole_6$1 false))
  (= $Check_spec~1.T_node~0.p1$1 (= false (ite %init $hole_7$1 (and (and $Check_spec~1.T_node~0.launch_bt$0 (not $Check_spec~1.T_node~0.reset_flag$1)) (not $Check_spec~1.T_node~0.reset_flag$0)))))
  (= $Check_spec~1.T_node~0.ok$1 (ite %init $hole_8$1 $Check_spec~1.T_node~0.p1$1))
  (= $Check_spec~1.H_discovery~0.out$1 (ite %init $Check_spec~1.stepOK$1 (and $Check_spec~1.stepOK$1 $Check_spec~1.H_discovery~0.out$0)))
  (= $~flatten0$1 (ite %init 1 2))
  (= $~flatten1$1 (ite %init 0 $~flatten0$0))
  (= $~flatten2$1 (ite %init false true))
  (= $~flatten3$1 (ite %init false $~flatten2$0))
  (ite %init true (= $hole_0$1 $hole_0$0))
  (ite %init true (= $hole_1$1 $hole_1$0))
  (ite %init true (= $hole_2$1 $hole_2$0))
  (ite %init true (= $hole_3$1 $hole_3$0))
  (ite %init true (= $hole_4$1 $hole_4$0))
  (ite %init true (= $hole_5$1 $hole_5$0))
  (ite %init true (= $hole_6$1 $hole_6$0))
  (ite %init true (= $hole_7$1 $hole_7$0))
  (ite %init true (= $hole_8$1 $hole_8$0))))
...
(assert (T true
$hole_0$~1 $hole_1 $hole_2 $hole_3 $hole_4 $hole_5 $hole_6 $hole_7 $hole_8 $ok$~1 $sig0$~1 $out0$~1 $Check_spec~0.ok$~1 $Check_spec~0.step$~1 $Check_spec~0.stepOK$~1 $Check_spec~1.ok$~1 $Check_spec~1.step$~1 $Check_spec~1.stepOK$~1 $Check_spec~0.T_node~0.ok$~1 $Check_spec~0.T_node~0.start_bt$~1 $Check_spec~0.T_node~0.launch_bt$~1 $Check_spec~0.T_node~0.reset_flag$~1 $Check_spec~0.T_node~0.p1$~1 $Check_spec~0.H_discovery~0.out$~1 $Check_spec~1.T_node~0.ok$~1 $Check_spec~1.T_node~0.start_bt$~1 $Check_spec~1.T_node~0.launch_bt$~1 $Check_spec~1.T_node~0.reset_flag$~1 $Check_spec~1.T_node~0.p1$~1 $Check_spec~1.H_discovery~0.out$~1 $~flatten0$~1 $~flatten1$~1 $~flatten2$~1 $~flatten3$~1

$hole_0 $hole_1 $hole_2 $hole_3 $hole_4 $hole_5 $hole_6 $hole_7 $hole_8 $ok$0 $sig0$0 $out0$0 $Check_spec~0.ok$0 $Check_spec~0.step$0 $Check_spec~0.stepOK$0 $Check_spec~1.ok$0 $Check_spec~1.step$0 $Check_spec~1.stepOK$0 $Check_spec~0.T_node~0.ok$0 $Check_spec~0.T_node~0.start_bt$0 $Check_spec~0.T_node~0.launch_bt$0 $Check_spec~0.T_node~0.reset_flag$0 $Check_spec~0.T_node~0.p1$0 $Check_spec~0.H_discovery~0.out$0 $Check_spec~1.T_node~0.ok$0 $Check_spec~1.T_node~0.start_bt$0 $Check_spec~1.T_node~0.launch_bt$0 $Check_spec~1.T_node~0.reset_flag$0 $Check_spec~1.T_node~0.p1$0 $Check_spec~1.H_discovery~0.out$0 $~flatten0$0 $~flatten1$0 $~flatten2$0 $~flatten3$0))
...
$hole_0$0 $hole_1 $hole_2 $hole_3 $hole_4 $hole_5 $hole_6 $hole_7 $hole_8 $ok$0 $sig0$0 $out0$0 $Check_spec~0.ok$0 $Check_spec~0.step$0 $Check_spec~0.stepOK$0 $Check_spec~1.ok$0 $Check_spec~1.step$0 $Check_spec~1.stepOK$0 $Check_spec~0.T_node~0.ok$0 $Check_spec~0.T_node~0.start_bt$0 $Check_spec~0.T_node~0.launch_bt$0 $Check_spec~0.T_node~0.reset_flag$0 $Check_spec~0.T_node~0.p1$0 $Check_spec~0.H_discovery~0.out$0 $Check_spec~1.T_node~0.ok$0 $Check_spec~1.T_node~0.start_bt$0 $Check_spec~1.T_node~0.launch_bt$0 $Check_spec~1.T_node~0.reset_flag$0 $Check_spec~1.T_node~0.p1$0 $Check_spec~1.H_discovery~0.out$0 $~flatten0$0 $~flatten1$0 $~flatten2$0 $~flatten3$0

$hole_0 $hole_1 $hole_2 $hole_3 $hole_4 $hole_5 $hole_6 $hole_7 $hole_8 $ok$1 $sig0$1 $out0$1 $Check_spec~0.ok$1 $Check_spec~0.step$1 $Check_spec~0.stepOK$1 $Check_spec~1.ok$1 $Check_spec~1.step$1 $Check_spec~1.stepOK$1 $Check_spec~0.T_node~0.ok$1 $Check_spec~0.T_node~0.start_bt$1 $Check_spec~0.T_node~0.launch_bt$1 $Check_spec~0.T_node~0.reset_flag$1 $Check_spec~0.T_node~0.p1$1 $Check_spec~0.H_discovery~0.out$1 $Check_spec~1.T_node~0.ok$1 $Check_spec~1.T_node~0.start_bt$1 $Check_spec~1.T_node~0.launch_bt$1 $Check_spec~1.T_node~0.reset_flag$1 $Check_spec~1.T_node~0.p1$1 $Check_spec~1.H_discovery~0.out$1 $~flatten0$1 $~flatten1$1 $~flatten2$1 $~flatten3$1))
...
$hole_0 $hole_1 $hole_2 $hole_3 $hole_4 $hole_5 $hole_6 $hole_7 $hole_8 $ok$2 $sig0$2 $out0$2 $Check_spec~0.ok$2 $Check_spec~0.step$2 $Check_spec~0.stepOK$2 $Check_spec~1.ok$2 $Check_spec~1.step$2 $Check_spec~1.stepOK$2 $Check_spec~0.T_node~0.ok$2 $Check_spec~0.T_node~0.start_bt$2 $Check_spec~0.T_node~0.launch_bt$2 $Check_spec~0.T_node~0.reset_flag$2 $Check_spec~0.T_node~0.p1$2 $Check_spec~0.H_discovery~0.out$2 $Check_spec~1.T_node~0.ok$2 $Check_spec~1.T_node~0.start_bt$2 $Check_spec~1.T_node~0.launch_bt$2 $Check_spec~1.T_node~0.reset_flag$2 $Check_spec~1.T_node~0.p1$2 $Check_spec~1.H_discovery~0.out$2 $~flatten0$2 $~flatten1$2 $~flatten2$2 $~flatten3$2))
...
$hole_0 $hole_1 $hole_2 $hole_3 $hole_4 $hole_5 $hole_6 $hole_7 $hole_8 $ok$3 $sig0$3 $out0$3 $Check_spec~0.ok$3 $Check_spec~0.step$3 $Check_spec~0.stepOK$3 $Check_spec~1.ok$3 $Check_spec~1.step$3 $Check_spec~1.stepOK$3 $Check_spec~0.T_node~0.ok$3 $Check_spec~0.T_node~0.start_bt$3 $Check_spec~0.T_node~0.launch_bt$3 $Check_spec~0.T_node~0.reset_flag$3 $Check_spec~0.T_node~0.p1$3 $Check_spec~0.H_discovery~0.out$3 $Check_spec~1.T_node~0.ok$3 $Check_spec~1.T_node~0.start_bt$3 $Check_spec~1.T_node~0.launch_bt$3 $Check_spec~1.T_node~0.reset_flag$3 $Check_spec~1.T_node~0.p1$3 $Check_spec~1.H_discovery~0.out$3 $~flatten0$3 $~flatten1$3 $~flatten2$3 $~flatten3$3))
...
$hole_0$3 $hole_1 $hole_2 $hole_3 $hole_4 $hole_5 $hole_6 $hole_7 $hole_8 $ok$3 $sig0$3 $out0$3 $Check_spec~0.ok$3 $Check_spec~0.step$3 $Check_spec~0.stepOK$3 $Check_spec~1.ok$3 $Check_spec~1.step$3 $Check_spec~1.stepOK$3 $Check_spec~0.T_node~0.ok$3 $Check_spec~0.T_node~0.start_bt$3 $Check_spec~0.T_node~0.launch_bt$3 $Check_spec~0.T_node~0.reset_flag$3 $Check_spec~0.T_node~0.p1$3 $Check_spec~0.H_discovery~0.out$3 $Check_spec~1.T_node~0.ok$3 $Check_spec~1.T_node~0.start_bt$3 $Check_spec~1.T_node~0.launch_bt$3 $Check_spec~1.T_node~0.reset_flag$3 $Check_spec~1.T_node~0.p1$3 $Check_spec~1.H_discovery~0.out$3 $~flatten0$3 $~flatten1$3 $~flatten2$3 $~flatten3$3

$hole_0 $hole_1 $hole_2 $hole_3 $hole_4 $hole_5 $hole_6 $hole_7 $hole_8 $ok$4 $sig0$4 $out0$4 $Check_spec~0.ok$4 $Check_spec~0.step$4 $Check_spec~0.stepOK$4 $Check_spec~1.ok$4 $Check_spec~1.step$4 $Check_spec~1.stepOK$4 $Check_spec~0.T_node~0.ok$4 $Check_spec~0.T_node~0.start_bt$4 $Check_spec~0.T_node~0.launch_bt$4 $Check_spec~0.T_node~0.reset_flag$4 $Check_spec~0.T_node~0.p1$4 $Check_spec~0.H_discovery~0.out$4 $Check_spec~1.T_node~0.ok$4 $Check_spec~1.T_node~0.start_bt$4 $Check_spec~1.T_node~0.launch_bt$4 $Check_spec~1.T_node~0.reset_flag$4 $Check_spec~1.T_node~0.p1$4 $Check_spec~1.H_discovery~0.out$4 $~flatten0$4 $~flatten1$4 $~flatten2$4 $~flatten3$4))
