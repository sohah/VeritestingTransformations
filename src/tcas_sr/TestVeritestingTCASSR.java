public class TestVeritestingTCASSR {


    void testHarness(TCASSREqCheck v,
                     int in0, int in1, int in2, int in3, int in4, int in5,
                     int in6, int in7, int in8, int in9, int in10, int in11) {
        Outputs outSPF = SPFWrapper(new TCASSREqCheck(), in0, in1, in2, in3, in4, in5, in6, in7, in8, in9, in10, in11);
        Outputs outJR = JRWrapper(new TCASSREqCheck(), in0, in1, in2, in3, in4, in5, in6, in7, in8, in9, in10, in11);
        checkEquality(v, outSPF, outJR);
    }

    private void checkEquality(TCASSREqCheck v, Outputs outSPF, Outputs outJR) {
...
//        assert(outSPF == outJR);
    ...
    private Outputs SPFWrapper(TCASSREqCheck v, int in0, int in1, int in2, int in3, int in4, int in5,
                               int in6, int in7, int in8, int in9, int in10, int in11) {
    ...
    private Outputs NoVeritest(TCASSREqCheck v, int in0, int in1, int in2, int in3, int in4, int in5,
                               int in6, int in7, int in8, int in9, int in10, int in11) {
        return SPFWrapperInner(v, in0, in1, in2, in3, in4, in5, in6, in7, in8, in9, in10, in11);
    }

    private Outputs SPFWrapperInner(TCASSREqCheck v, int in0, int in1, int in2, int in3, int in4, int in5,
                                    int in6, int in7, int in8, int in9, int in10, int in11) {
        Outputs ret = v.testFunction(in0, in1, in2, in3, in4, in5, in6, in7, in8, in9, in10, in11);
        return ret;
    }

    private Outputs JRWrapper(TCASSREqCheck v, int in0, int in1, int in2, int in3, int in4, int in5,
                              int in6, int in7, int in8, int in9, int in10, int in11) {
        return v.testFunction(in0, in1, in2, in3, in4, in5, in6, in7, in8, in9, in10, in11);
    }

    public void runTest(TCASSREqCheck t) {
